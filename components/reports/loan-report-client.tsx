        ...
        <div className={isPreviewOpen ? "print:hidden space-y-6" : "space-y-6"}>
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3 bg-payroll-cream p-2 rounded-xl border border-payroll-light">
              <div className="inline-flex rounded-lg border border-payroll-light bg-white p-1 shadow-payroll-sm">
                <button
                  type="button"
                  onClick={() => setLoanTab("DISBURSEMENTS")}
                  className={`rounded-md px-3 py-1.5 text-xs font-bold transition-all ${
                    loanTab === "DISBURSEMENTS" ? "bg-payroll-primary text-white shadow-payroll-sm" : "text-gray-600 hover:text-payroll-navy"
                  }`}
                >
                ...
                <button
                  ...
                  className={`rounded-md px-3 py-1.5 text-xs font-bold transition-all ${
                    loanTab === "REPAYMENTS" ? "bg-emerald-600 text-white shadow-payroll-sm" : "text-gray-600 hover:text-payroll-navy"
                  }`}
                >
                ...
                <button
                  ...
                  className={`rounded-md px-3 py-1.5 text-xs font-bold transition-all ${
                    loanTab === "SUMMARY" ? "bg-payroll-navy text-white shadow-payroll-sm" : "text-gray-600 hover:text-payroll-navy"
                  }`}
                >
